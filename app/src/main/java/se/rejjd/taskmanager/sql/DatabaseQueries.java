...
public class DatabaseQueries {
    ...
    public static final String CREATE_TABLES_USERS = "CREATE TABLE " + ModelEntry.USERS_COLUMN_NAME_TEAM_ID + " FOREIGN KEY, " + ModelEntry.USERS_COLUMN_NAME_USERNAME + " TEXT NOT NULL, " +
